...
app.post('/usuario', (req, res) => {
    ...
    const query = 'INSERT INTO dadosUsuario (nome, email, senha,confirmar_senha) VALUES (?, ?, ?, ?)';
...
app.post('/Ong', (req, res) => {
    const { email, confimar_email, senha, confirmar_senha, nome, foto, categoria, descricao } = req.body;
    console.log(senha);
    console.log("Dados recebidos:", req.body);  // Log dos dados recebidos
    console.log("Senha recebida:", senha);  // Log da senha
    ...
    const hashedPassword = bcrypt.hashSync(senha, salt);
        ...
        const query = 'INSERT INTO dadosOng (email, confimar_email, senha, confirmar_senha, nome, foto, categoria, descricao) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
        connection.query(query, [email, confimar_email, senha, confirmar_senha, nome, foto, categoria, descricao, hashedPassword], (err, results) => {
            if (err) {
                console.error("Erro ao inserir os dados:", err);
                res.send("Erro ao cadastrar. Tente novamente.");
            } else {
